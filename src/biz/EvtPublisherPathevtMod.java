...
public class EvtPublisherPathevtMod  implements ApplicationEventPublisher {

    public void publishEvent(String evtNamePath, Object prm) {

        Set<Method> obsSet = evtHdrMapStrStMod.get(evtNamePath);
        for (Method m : obsSet) {
            Object obj = null;
            try {
