...
//    }
    ...
    public void setTxRollback4updt(String data_id, @NotBlank String collName) throws Exception {
        if (conn.autoCommit == false)
            return;
        String data_loc = collName + "/" + data_id;
    ...
    public void setTxRollback4persist(String dataId, @NotBlank String collName) {
        if (conn.autoCommit == false)
            return;
    ...
    public boolean existDataInDB(String data_loc) {
