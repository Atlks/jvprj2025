 ...
 *
 *
 * @param <dto> the type of the input to the function
 * @param <R> the type of the result of the function
 *
 * @since 1.8
 */
@FunctionalInterface
public interface FunctionX<dto, R> extends Serializable {
     ...
     */
    R apply(dto t, FunContext ctx1) throws Throwable;
     ...
     */
//    default <V> FunctionX<V, R> compose(FunctionX<? super V, ? extends dto> before) {
...
//    }
     ...
     */
//    default <V> FunctionX<dto, V> andThen(FunctionX<? super R, ? extends V> after) {
//        Objects.requireNonNull(after);
//        return (dto t) -> after.apply(apply(t));
//    }
     ...
     */
    static <T,ctx>  FunctionX<T, T> identity() {
        return (t,ctx) -> t;
    }
